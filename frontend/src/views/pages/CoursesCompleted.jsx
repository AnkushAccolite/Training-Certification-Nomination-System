          ...
          <div style={{ height: 'calc(100vh - 300px)', overflowY: 'auto', overflowX: 'hidden' }}>
            ...
            >
              <Table aria-label="completed courses table">
                <TableHead>
                  <TableRow>
                    <TableCell onClick={() => handleSort('SNo')} style={{ textAlign: 'center', cursor: 'pointer',fontSize: '16px', fontWeight: 'bold' }}>
                    ...
                    <TableCell onClick={() => handleSort('DateOfCompletion')} style={{ textAlign: 'center', cursor: 'pointer' ,fontSize: '16px', fontWeight: 'bold'}}>
