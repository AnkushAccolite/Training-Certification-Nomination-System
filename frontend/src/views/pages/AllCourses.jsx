...
const AllCourses = () => {
  ...
  // Filter courses based on selected domain and search query
  const filteredCourses = courses.filter((course) => {
    const courseNameLowerCase = course.coursename.toLowerCase();
    const searchQueryLowerCase = searchQuery.toLowerCase();
    const isDomainMatched = selectedDomain === 'All' || course.domain === selectedDomain;
    const isSearched = courseNameLowerCase.includes(searchQueryLowerCase);
    return isDomainMatched && isSearched;
  });
